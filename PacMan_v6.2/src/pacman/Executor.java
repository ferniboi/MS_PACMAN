...
//		HumanController pacManController = new HumanController(new KeyBoardInput())
//		ExpertPacMan pacManController = new ExpertPacMan();
//		AStarPacMan pacManController = new AStarPacMan();
//		AlphaBetaPacMan pacManController = new AlphaBetaPacMan();
		MinimaxPacMan pacManController = new MinimaxPacMan();
//		ExpectiMinimaxPacMan pacManController = new ExpectiMinimaxPacMan();

		Legacy ghostsController = new Legacy();
//		Legacy2TheReckoning ghostsController = new Legacy2TheReckoning();
//		RandomGhosts ghostsController = new RandomGhosts();
//		AggressiveGhosts ghostsController = new AggressiveGhosts();
//		StarterGhosts ghostsController = new StarterGhosts();

//		exec.runExperiment(pacManController, ghostsController, runs);
		exec.runGameTimedSpeedOptimised(pacManController, ghostsController, fixedTime, visual);
//		exec.runGameTimed(pacManController, ghostsController, visual);
//		exec.runGame(pacManController, ghostsController, visual, delay);
	}
	...
	public void runExperiment(Controller<MOVE> pacManController, Controller<EnumMap<GHOST, MOVE>> ghostController,
		...
		System.out.println("avgScore\t" + avgScore / trials);
		System.out.println("avgLives\t" + avgLives / trials);
